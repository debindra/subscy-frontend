      ...
      return (
        <div className="space-y-5 text-center">
          ...
          <Link
            ...
            className="inline-flex items-center justify-center px-4 py-2 rounded-lg bg-brand-accent-500 text-white hover:bg-brand-accent-600 transition-colors focus:outline-none focus:ring-2 focus:ring-brand-accent-500 focus:ring-offset-2"
          >
