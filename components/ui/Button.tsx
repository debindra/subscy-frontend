...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variantClasses = {
    ...
    accent: 'bg-brand-accent-500 dark:bg-brand-accent-500 text-white hover:bg-brand-accent-600 dark:hover:bg-brand-accent-600 focus:ring-brand-accent-500 disabled:bg-gray-400 dark:disabled:bg-gray-600',
