    ...
    <div className="relative w-full sm:w-auto">
      ...
      {showMenu && (
        <>
          ...
          />
          <div className="absolute left-0 sm:right-0 sm:left-auto top-full mt-2 w-full sm:w-48 max-w-[calc(100vw-2rem)] sm:max-w-none bg-white dark:bg-gray-800 rounded-lg shadow-lg border dark:border-gray-700 z-50 max-h-[60vh] sm:max-h-none overflow-y-auto" style={{ maxHeight: '60vh' }}>
            <button
