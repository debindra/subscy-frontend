    ...
    <Card className="hover:shadow-xl dark:hover:shadow-gray-900/50 transition-all duration-300 transform hover:-translate-y-1 animate-fade-in relative overflow-hidden group">
      ...
      <div className="relative">
        ...
        <div className="flex items-center space-x-4 mb-5">
          <div className={`p-3.5 rounded-xl ${iconClasses} transition-transform group-hover:scale-105 shrink-0 [&_svg]:!text-current [&_svg]:h-10 [&_svg]:w-10 shadow-sm`}>
            {subscriptionIcon}
          </div>
        ...
        <div className="space-y-2 mb-4">
          ...
          {daysUntilRenewal >= 0 && (
            <div
              ...
              role="status"
              aria-label={`${daysUntilRenewal === 0 ? 'Renews today' : `${daysUntilRenewal} days remaining`}`}
            >
          ...
          {isOverdue && (
            <div
              className="inline-flex items-center gap-2 px-3 py-2 text-xs rounded-lg bg-red-50 dark:bg-red-900/20 text-red-700 dark:text-red-400 border border-red-200 dark:border-red-800"
              role="alert"
